export default function NavBar() {
    return (
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-900 font-[family-name:var(--font-geist-sans)]">
                <div className="flex flex-wrap justify-between items-center mx-auto">
                    <a href="" className="flex items-center">
                        <span className="self-center text-xl font-extrabold whitespace-nowrap dark:text-white">BlackMarket</span>
                    </a>
